...
struct WriteArticleService: PostableService{
    typealias NetworkData = DefaultVO
    static let shareInstance = WriteArticleService()
    func writeArticleReview(url : String, params : [String : Any], completion : @escaping (NetworkResult<Any>) -> Void){
