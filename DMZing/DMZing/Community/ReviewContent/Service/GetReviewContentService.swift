...
struct GetReviewContentService : GettableService {
    typealias NetworkData = ReviewContentVO
    static let shareInstance = GetReviewContentService()
