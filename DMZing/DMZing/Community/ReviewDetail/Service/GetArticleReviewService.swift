...
struct GetArticleReviewService : GettableService {
    typealias NetworkData = ArticleReviewVO
    static let shareInstance = GetArticleReviewService()
